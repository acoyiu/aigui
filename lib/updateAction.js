    ...
    Page: tObj => {
        ...
        switch (sign) {
            ...
            case 'To':
                ...
                tag.nodeName === 'image'
                    ? new AiJs.Button(tag, { scaleRatio: 0.9, center: 5, end: () => window.changePage(pageToGo) })
                    : new AiJs.Button(tag, { scaleRatio: 0.9, center: 5, start: () => window.changePage(pageToGo) });
                break;
        }
    },
